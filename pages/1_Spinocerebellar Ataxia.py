...
with st.container():
    st.write("---")
    st.markdown("### What is Spinocerebellar Ataxia (SCA)?<sup>3,5,6</sup>", unsafe_allow_html=True)
...
with st.container():
    st.write("---")
    st.markdown("### Types of Spinocerebellar Ataxia<sup>2,3,5,6,7</sup>", unsafe_allow_html=True)
...
with st.container():
    ...
    st.markdown("#### Overview of Genetic Causes of Dominant SCA<sup>2,6</sup>", unsafe_allow_html=True)
...
st.markdown("#### Overview of Genetic Causes of Recessive Cerebellar Ataxias<sup>1</sup>", unsafe_allow_html=True)
...
with st.container():
    ...
    st.write("5. Klockgether, T., Mariotti, C., & Paulson, H. L. (2019). Spinocerebellar ataxia. Nature Reviews. Disease Primers, 5(1), 24–24. https://doi.org/10.1038/s41572-019-0074-3")
    st.write("6. Sun, Y.-M., Lu, C., & Wu, Z.-Y. (2016). Spinocerebellar ataxia: relationship between phenotype and genotype - a review. Clinical Genetics, 90(4), 305–314. https://doi.org/10.1111/cge.12808")
    st.write("7. Whaley, N. R., Fujioka, S., & Wszolek, Z. K. (2011). Autosomal dominant cerebellar ataxia type I: A review of the phenotypic and genotypic characteristics. Orphanet Journal of Rare Diseases, 6, 33. https://doi.org/10.1186/1750-1172-6-33")
